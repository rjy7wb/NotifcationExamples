...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    @FXML
    private Button tskButton1;
    
    @FXML
    private Button tskButton2;
    
    @FXML
    private Button tskButton3;
        ...
        if (task3 == null) {
            ...
            task3.addPropertyChangeListener((PropertyChangeEvent evt) -> {
                if(evt.getNewValue().equals("Task3 done.") || evt.getNewValue().equals("Task3 Stopped.")){
                    task3 = null;
                    tskButton3.setText("Task 3");
                }
                textArea.appendText((String)evt.getNewValue() + "\n");
            });
            
            task3.start();
            tskButton3.setText("End Task3");
        }
        else {
            task3.end();
            task3 = null;
